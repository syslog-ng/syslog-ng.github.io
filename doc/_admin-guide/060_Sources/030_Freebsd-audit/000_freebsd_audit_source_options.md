...
Technically, this sources is a specialized versions of a program() source that uses the FreeBSD `praudit` command line tool to collect the audit logs. See the program() source options for more details.
