...
template functions use a syntax similar to command lines. For the available
value-pairs options, see the [[value-pairs options|adm-spec-value-pairs#value-pairs-options]]
reference.
...
format-flat-json template function. It supports the same value-pairs options
as format-json; see the
...
value-pairs(): format-json uses a syntax similar to command lines. For the
available value-pairs options, see the
[[value-pairs options|adm-spec-value-pairs#value-pairs-options]] reference.
...
the value-pairs() option. For details on selecting value-pairs, see the
[[value-pairs options|adm-spec-value-pairs#value-pairs-options]] reference.
...
| *Syntax:* | $(names value-pairs-options) |

*Description:* Returns the names of the selected value-pairs as a list. For
example:

```config
$(names --scope nv-pairs --exclude password)
```

For the available selection, exclusion, and transformation options, see the
[[value-pairs options|adm-spec-value-pairs#value-pairs-options]] reference.

### $(values)

| *Syntax:* | $(values value-pairs-options) |

*Description:* Returns the values of the selected value-pairs as a list. For
example:

```config
$(values --scope nv-pairs --exclude password)
```
