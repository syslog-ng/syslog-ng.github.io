...
The configuration file location can also be specified using the `--cfgfile <file>` or `-f <file>` startup options. For all supported command-line options, see the {{ site.product.short_name }} OSE manual page.
